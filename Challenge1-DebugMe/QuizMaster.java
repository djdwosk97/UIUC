//UIUC CS125 FALL 2013 MP. File: QuizMaster.java, CS125 Project: Challenge1-DebugMe, Version: 2013-09-10T09:38:46-0500.901340225
/**
...
public class QuizMaster {
	...
	public static void main(String[] args) {
		...
		int zip = TextIO.getlnInt(); //61802-Illinois, 48502-Michigan, 53701-Wisconsin
		...
		int score = 0;
		if(gridComputing == 1) score += 10; 
		if(illiac == 1) score += 10; 
		if(mosaic == 1) score += 10; 
		if(varTF == 1) score += 10; 
		
		if(zip == 48502 && score < 40) System.out.print("You scored:0");
		if(zip == 48502 && score == 40)	System.out.print("You scored:" + score);
		
		if(zip == 53701) System.out.print("You scored:" + score); 
		
		if(zip == 61802 && score == 40) System.out.println("You scored:" + score + "\n Congragulations!");
		if(zip == 61802 && score < 40) System.out.print("You scored:" + score);
	}
}
