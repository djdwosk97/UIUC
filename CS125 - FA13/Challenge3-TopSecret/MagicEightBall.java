//UIUC CS125 FALL 2013 MP. File: MagicEightBall.java, CS125 Project: Challenge3-TopSecret, Version: 2013-09-21T11:10:53-0500.511668125
 /**
...
public class MagicEightBall {
	...
	public static void main(String[] args) {
		...
		if (!happy && hours < 10) TextIO.put("Embarrassing Michigan Road Trip");
		else if (social && happy && hours > 20) TextIO.put("Ace CS125 Exam"); 
		else if (social && !happy && hours > 15) TextIO.put("Rick Rolled Four Times in One Day");
