<?php
	...
	if($_SERVER["REQUEST_METHOD"] == "POST") {
      		...
      		if($count == 1) {
         		...
         		$sql1 = "UPDATE admin set date = (select NOW() limit 1) where username = '$myusername'";
         ...
         <div style = "width:300px; border: solid 1px #333333; " align = "left">
            ...
            <div style = "margin:30px">
               ...
               <form action = "" method = "post">
                  ...
                  <input type = "submit" value = " Submit " formaction="" /><br />
		  <input type = "submit" value = " Create Accout " formaction="create.php" /><br />
               </form>
