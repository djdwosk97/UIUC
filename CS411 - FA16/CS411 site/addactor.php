...
<body>
			...
			<div id="header">
					...
					<ul class="navigation">
						...
						<li class="active"><a href="actors.php">My Actors</a></li>
						<li><a href="recommendations.php">Recommendations</a></li>
						<li><a href="activemembers.php">Active Users</a></li>
			...
			<div id="body">
				...
				<div id="content">
					<?php 
						...
						$sub_sub ="SELECT id from ACTOR where name='$data'";
						$sql = "INSERT INTO actor_like (id,actor_id) VALUE (($sub),($sub_sub))";
						 ...
						 if($insert)
                					{
                        					...
                        					echo "\r\n";
                        					$sql1 = "Select distinct name from ACTOR where id IN (select actor_id from actor_like where id = (select id from admin where username ='$u'))";
                        					//echo $sql1;
                                ...
                                <th>Favorites</th>
                                				...
                                				while($row = $insert1->fetch_assoc()) {
                        							...
                        							//echo "<td>" . '<a href="movies.php?data=' . $row["id"] . '">' . 'Go to Movie</a>';
                                                                                //echo "<td>" . '<a href="removeFromMovies.php?data=' . $row["id"] . '">' . 'Remove from My Movies</a>';
										echo "</tr>";
                                				}
                    						echo "</table>";
                					}
